    ...
    <div class="div-content container my-4 px-4 py-4">
        <div class="row">
            <div class="col-12 col-md-6">
                <header>
                    <h4>Novo <span class="text-warning">Produto</span></h4>
                ...
                <form method="post" id="formProduct" action="#">
                    <div class="row">
                        <div class="col-12 mb-3">
                            ...
                            <input type="text" class="form-control name" id="name" name="name" placeholder="Blusa Nike" />
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-5 col-sm-12 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control price" id="price" placeholder="59,99" name="price" data-mask="000.000,00" data-mask-reverse="true" />
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-12 col-md-6 col-lg-4">
                ...
                <div class="card-product">
                    <div class="product-tumb">
                        <img class="" id="preview-img" src="https://via.placeholder.com/280x255">
                    </div>
                    <div class="card-content pt-1">
                        <h4 class="card-title">Nome Produto</h4>
                        <div class="card-price">R$ <span class="price">00.00</span></div>
